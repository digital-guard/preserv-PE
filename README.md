...
A Perú se le asignó: en el contexto [ISO&nbsp;3166](https://en.wikipedia.org/wiki/ISO_3166) el geocódigo [**PE**](https://en.wikipedia.org/wiki/ISO_3166-2:PE) y el número [**604**](https://en.wikipedia.org/wiki/ISO_3166-1_numeric); en [Wikidata](https://wikidata.org) el identificador [Q419](http://wikidata.org/entity/Q419); en [OpenStreetMap](https://osm.org) el identificador de [*relación* 288247](http://osm.org/relation/288247).
